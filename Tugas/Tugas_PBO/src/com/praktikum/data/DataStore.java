...
public class DataStore {
    ...
    static {
        // Default Admin
        userList.add(new Admin("Administrator", "ADMIN123", "admin311", "password311"));

        // Default Mahasiswa
        userList.add(new Mahasiswa("Mohammad Putra Akbar Rafsanjani", "202410370110311"));
    ...
    public static User loginMahasiswa(String nama, String nim) {
        for (User user : userList) {
            if (user instanceof Mahasiswa) {
                if (user.getNama().equals(nama) && user.getNim().equals(nim)) {
                    return user;
                }
            }
        }
