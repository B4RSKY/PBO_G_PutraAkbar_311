...
public class LoginPane extends VBox {
    ...
    public LoginPane(MainApp mainApp) {
        ...
        Label labelkedua = new Label("Label kedua");
        grid.add(userTypeLabel, 0, 0);
        grid.add(labelkedua, 2, 0);
        ...
        PasswordField input2Field = new PasswordField(); // PasswordField for password
        ...
        getChildren().addAll(sceneTitle, grid, actionTarget, pass);
    }
}
